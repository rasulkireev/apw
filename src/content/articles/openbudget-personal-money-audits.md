---
title: Using AI to Audit My Personal Finances
dateCreated: 2026-06-19
dateUpdated: 2026-06-19
published: true
slug: openbudget-personal-money-audits
...
category: Personal
type: article
description: A short note on using OpenBudget to make personal finance reviews easier with AI.
---
...
- Did any random charge appear that I should look into?
...
That is the part that feels useful to me. I already use AI for code, notes, summaries, research, planning, and random life admin. Personal finance should probably be part of that same workflow.

The workflow I want is pretty straightforward:

1. Run a monthly audit.
2. Ask what changed compared to last month.
3. Find hidden recurring payments.
4. Check whether any returns or refunds are missing.
5. Ask follow-up questions about specific transactions.
...
I have not turned this into a perfect system yet, but I can already see the shape of it. Once a month, instead of staring at bank statements, I want to ask:
