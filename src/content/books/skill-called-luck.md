---
title: "A Skill Called Luck"
author: "Jakob Greenfeld"
rating: 8
slug: "a-skill-called-luck"
description: "A practical guide to actively increasing your 'luck surface area' by focusing on hustle, strategic setup, cultivating creativity, and building capacity. Learn to engineer serendipity through networking, working in public, optimizing your environment, and developing key skills and a positive mindset."
cover: "./images/a-skill-called-luck.png"
dateRead: 2025-10-27
dateCreated: 2026-01-05
dateUpdated: 2026-01-05
category: "Self-Improvement"
type: book
notAffiliateLink: https://jakobgreenfeld.gumroad.com/l/luck
hasSummaries: false
tags:
  - Luck
  - Serendipity
...
1) “You can wait passively and hope that the world will eventually recognize your genius. Or you can develop and execute a plan to actively increase your luck surface.”
...
2) “It’s always possible to stack the odds in your favor. You can actively create optimal conditions for lucky things to happen to you.”
...
3) “Hustle is about proactively bringing more luck into your life… it’s always about people.”
...
4) “Doing a ton of work without ever telling anyone about it won’t open any new doors for you.”
...
1) **Daily Luck Surface Agent (Visibility + Outreach)**
**Goal:** Make “one small public output + one new connection” automatic.
...
- **Prompt skeleton:**
  > You are my Luck Surface Agent. Turn today’s work notes into (1) a short public progress post, (2) a slightly longer reflection for my newsletter, and (3) three outreach messages to relevant people.
  > Constraints: be specific, non-cringy, and include a clear “hook” (problem/insight/lesson). Outreach messages must include a genuine reason, one concrete compliment, and a low-friction question.

2) **Serendipity Ask Agent (Make Wishes Known)**
**Goal:** Regularly broadcast what you want (help, intros, feedback).
...
3) **Network Warmer Agent (Nurture Relationships)**
**Goal:** Keep your network warm with minimal effort.
...
4) **Coworking/Cafe Scheduler Agent (Offline Luck Surface)**
**Goal:** Nudge you into higher-serendipity environments without wrecking deep work.
...
5) **Openness/Friction Audit Agent (Inbound Setup)**
**Goal:** Make it easy for people to reach you.
...
6) **Origin Story / Luck Magnet Agent**
**Goal:** Create a compelling “why me, why now” asset you can point people to.
...
7) **Input Diet Agent (Creativity + Attention)**
**Goal:** Reduce “intellectual junk food” and improve idea quality.
...
8) **Idea Prompt Generator Agent (Creativity Prompts)**
**Goal:** Turn the book’s prompt list into a recurring idea pipeline.
...
9) **Skills-to-Luck Roadmap Agent (Capacity)**
**Goal:** Build “seize-the-opportunity” capacity (sell/build/write).
...
10) **Pre-Room Energy Agent (Mindset + Likeability)**
**Goal:** Ritualize “choose to have a good time / be open” before social situations.
...
Offline a good rule of thumb is to stick to the [“Hotel Bathroom” dress code](https://perell.com/essay/serendipity/). Always dress well enough to walk into a bathroom at a hotel you’re not staying at and get away with it. This way you’ll also always look sharp enough to capitalize on any serendipitous encounter.
